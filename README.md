...
Quaternions can be stacked to perform multiple rotations for example given $\vec{u}\in\mathbf{R}^3$ and $\theta_1$ 
the angle needed to rotate $\vec{u}$ to lie in the XY plane and $\theta_2$ the angle needed to then rotate it unto 
